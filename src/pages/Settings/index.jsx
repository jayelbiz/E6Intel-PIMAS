  ...
  return (
    <div className="flex flex-column gap-4">
      <Card className="surface-card shadow-2">
        <div className="flex flex-column gap-4">
          <h2 className="text-xl font-bold m-0">Preferences</h2>
          <TabView>
            ...
            <TabPanel header="News">
              <div className="p-fluid">
                <div className="flex align-items-center justify-content-between mb-4">
                  ...
                  <Dropdown
                    id="region"
                    value={settings.filters.region}
                    options={regionOptions}
                    onChange={(e) => handleSettingChange('filters', 'region', e.value)}
                  />
                </div>
              </div>
            </TabPanel>
